									...
									<?php
										function pixelwars_core_main_slider__featured_media($width)
										{
											...
											elseif (has_post_thumbnail())
											{
												...
												{
													$feat_img = wp_get_attachment_image_src(get_post_thumbnail_id(), 'lahanna_image_size_1');
												}
												else
												{
													if ($width == 'w-50')
													...
													{
														$feat_img = wp_get_attachment_image_src(get_post_thumbnail_id(), 'lahanna_image_size_7');
													}
												}
